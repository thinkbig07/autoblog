...
tags_contents_mapping = {
    ...
    # "澎湃新闻":["/html/body/div[3]/div[1]/div[1]/h1", "/html/body/div[3]/div[1]/div[1]/div[3]/div"],
    ...
    "爱范儿 · Beats of Bits":["//*[@id='content-meta-header']/div/h1",  "//*[@id='article-content-wrapper']/div/article"]
                         }